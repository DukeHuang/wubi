...
//142
    static let imagegbkKeys = [
        ...
        "A": [204, 446], "S": [344, 446], "D": [485, 446], "F": [626, 446], "G": [767, 446], "H": [921, 446], "J": [1062, 446], "K": [1203, 446], "L": [1344, 446],
...
//    }
    ...
    public lazy var imagegbkDict : Dictionary<String, UIImage> = {
        var dict = Dictionary<String, UIImage>()
        let image = UIImage.init(named: "iWuBi-gbk-keyboard")
        for (key, value) in KeyboardImageManager.imagegbkKeys {
            let rect = CGRect(x: value[0], y: value[1], width: 120, height: 148)
            dict[key] = image?.cropping(to: rect)
        }
        return dict
    }()
    ...
    public lazy var rect98Dict : Dictionary<String, UIImage> = {
        var dict = Dictionary<String, UIImage>()
        let image = UIImage.init(named: "iWuBi-98-keyboard")
        for (key, value) in KeyboardImageManager.image98Keys {
            let rect = CGRect(x: value[0], y: value[1], width: 113, height: 121)
